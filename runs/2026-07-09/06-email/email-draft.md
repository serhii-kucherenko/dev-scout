...
- MCP servers for IDE workflows (both) — https://github.com/modelcontextprotocol/servers
- Claude Code CLI setup (both) — https://github.com/anthropics/claude-code
- Eval harness for LLM regressions (robustness) — https://github.com/openai/evals
- Ralph loop agent harness (speed) — https://github.com/vercel-labs/ralph-loop-agent
- LangGraph production deploy patterns (robustness) — https://github.com/langchain-ai/langgraph
