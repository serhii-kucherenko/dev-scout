...
### LangGraph production deploy patterns

**Why:** What deploy, observability, or rollback patterns shipped from real teams?

**Benefit:** robustness | **Grade:** B

**Evidence:** named production outcome
...
### build-robust
- [Eval harness for LLM regressions](https://github.com/openai/evals)

### production-patterns
- [LangGraph production deploy patterns](https://github.com/langchain-ai/langgraph)

### ship-faster
- [Ralph loop agent harness](https://github.com/vercel-labs/ralph-loop-agent)
- [Cursor agent workflow docs](https://docs.cursor.com/agent)

### tooling-setups
- [MCP servers for IDE workflows](https://github.com/modelcontextprotocol/servers)
- [Claude Code CLI setup](https://github.com/anthropics/claude-code)
