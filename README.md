...
3. The agent researches the web, writes artifacts under `runs/YYYY-MM-DD/`, and points you to the email draft when done

**Continue later:**

```
Continue the dev scout loop for runs/YYYY-MM-DD/. Read RUN.md and pick up where we left off.
```
...
| `runs/YYYY-MM-DD/05-report/daily-digest.md` | Full cookbook with all links and steps |
| `runs/YYYY-MM-DD/01-research/` | Auditable research trail |

## Mission

Learn new practical workflows each day: agent harnesses, tooling setups, testing patterns, production practices that move real metrics. **Research is the core** — email and digest are outputs, not the product.
...
runs/YYYY-MM-DD/    ← daily artifacts
